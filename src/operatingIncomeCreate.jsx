...
function OperatingIncomeCreate() {
  ...
  // Populate default months for added years
  useEffect(() => {
    setMonthInputs((prev) => {
      const key = `year${visibleYears}`;
      if (prev[key]) return prev;
      const newMonths = {};
      months.forEach((m) => (newMonths[m] = ""));
      return {
        ...prev,
        [key]: newMonths
      };
      ...
      years: [...Array(visibleYears)].map((_, index) => {
        ...
        return {
          ...
          months: Object.entries(monthInputs[key] || {}).map(
            ([month, value]) => ({
              month,
              value: parseFloat(value) || 0 // ensures number, defaults to 0 if empty or invalid
            })
          )
        };
      })
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Enter your monthly operating income data
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• Enter monthly operating income in numbers (e.g., 55000)</li>
...
export default OperatingIncomeCreate;
