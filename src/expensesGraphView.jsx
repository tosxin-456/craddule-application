...
function ViewExpensesGraph({ projectId, graphType }) {
  ...
  const transformGraphData = (graphData) => {
    ...
    const series = graphData.years[0].months.map((monthData) =>
      parseFloat(monthData.value)
    );
...
export default ViewExpensesGraph;
