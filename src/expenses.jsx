...
function Expenses() {
  ...
  const handleViewClick = (id) => {
    navigate(`/expensesGraphView/${id}`); // Navigate to the view page with the ID as a parameter
  };

  const handleEditClick = (id) => {
    navigate(`/expensesEdit/${id}`); // Navigate to the view page with the ID as a parameter
  };
  ...
  const onClickHandler = () => navigate(`/expensesCreate`);
  return (
            ...
            {graphData.length === 0 && (
              <div className="text-center py-12">
                ...
                <div className="text-gray-400 text-sm">
                  Create your first expense graph to get started
                </div>
              </div>
            )}
          </div>
